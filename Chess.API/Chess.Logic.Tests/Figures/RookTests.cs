...
namespace Chess.Logic.Tests.Figures
{
    ...
    public class RookTests
    {
        ...
        public void GetPossibleMoves_WhenThereArePossibleMoves_And_BoardIsInitialized_ReturnsListOfPossibleMoves
            (Color color, string currentLocation, int expectedValidMoves)
        {
            //Arrange
